	        ...
	        $.ajax({
	            ...
	            success: function(result) {
	                ...
	                for(var index = 0; index < result.length; index++){
	                	if (index%2 == 0){
	                		devicesHtmlEven +='<div class="form-check"> <label class="form-check-label" style="word-wrap: break-word;max-width: 100%;"> <input type="checkbox" class="form-check-input devices" name="devices" value="'+result[index]['id']+'">'+result[index]['id']+'</label> </div>'
	                	}
	                	else{
	                		devicesHtmlOdd +='<div class="form-check"> <label class="form-check-label" style="word-wrap: break-word;max-width: 100%;"> <input type="checkbox" class="form-check-input devices" name="devices" value="'+result[index]['id']+'">'+result[index]['id']+'</label> </div>'
	                	}
	                }
